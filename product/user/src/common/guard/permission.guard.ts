export { SystemPermissionMap } from '@backend-x/gateway/constant/permission.constant';
...
import {
    ...
    UserPermissionType,
} from '@backend-x/gateway/constant/permission.constant';
import { CanActivate, ExecutionContext, Injectable } from '@nestjs/common';
import {
    AdminPermissionForbiddenError,
    PermissionForbiddenError,
} from '@backend-x/gateway/constant/error/auth/permission.error';
import { UserService } from '@backend-x/gateway/router/user/user.service';
